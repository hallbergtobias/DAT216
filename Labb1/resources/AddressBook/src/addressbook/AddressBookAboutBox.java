...
public class AddressBookAboutBox extends JDialog {
    
    public AddressBookAboutBox(JFrame parent){
        super(parent);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle aboutBundle = java.util.ResourceBundle.getBundle("addressbook/resources/AddressBookAboutBox"); // NOI18N
        java.util.ResourceBundle appBundle = java.util.ResourceBundle.getBundle("addressbook/resources/AddressBook"); // NOI18N
      
        imageLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/addressbook/resources/about.png"))); // NOI18N
